...
<head>
    ...
    <style type="text/css">
    	body
    	{
    		/*background-image: url("image/feedback3.jfif");
    		background-image: no-repeat;
    		background-size: 100% 100%;#b2deb2*/
...
<body>
      <div class="box2"><br><br><br>
     	<p style="font-size: 35px; text-align: center">Help us to grow with your suggestions.... <br><br>
